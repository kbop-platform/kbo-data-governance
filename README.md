...
KBO 신규 시스템(RFP DAR-001) 구축을 위한 데이터 표준, 코드 체계, 거버넌스 정책을 정의한 문서입니다.
...
| 영역 | 설명 | 바로가기 |
|------|------|---------|
| **데이터 사전** | 39종 테이블, 787개 컬럼 상세. 레거시→표준 매핑 포함 | [테이블 조감도](dictionary/index.md) |
...
| **거버넌스** | 오너십, 품질 규칙, 변경 절차, 설계 가이드 | [데이터 오너십](governance/data-ownership.md) |
| **분석 결과** | 현행 시스템 분석 7건 | [테이블 매핑](analysis/table-mapping.md) |
