...
ln -sfn ../standards-dict docs/standards-dict
ln -sf ../home.md docs/index.md
ln -sf ../project-guide.md docs/project-guide.md
ln -sf ../architecture.md docs/architecture.md
ln -sf ../development-guide.md docs/development-guide.md
