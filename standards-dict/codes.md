...
<div class="grid-filter-bar">
  ...
  <div class="filter-group">
    <label class="filter-label" for="sel-code-group">코드그룹</label>
    <select id="sel-code-group" data-field="code_group"><option value="">전체</option></select>
  </div>
...
<!-- AG Grid -->
<div id="codes-grid" class="ag-theme-alpine ag-theme-kbo" style="height:70vh;width:100%"></div>

<!-- Status Bar -->
<div class="grid-status">
  <div class="status-left">
    <span id="status-count">168건 표시</span>
  </div>
  <div>
