...
<div class="grid-page-info">
  <div class="grid-page-desc">컬럼명·테이블명에 사용하는 표준 약어. 명명 규칙의 기본 단위</div>
  <div class="grid-stats-inline">
    <span class="stat-inline"><strong id="stat-abbr-total">118</strong> 약어</span>
    <span class="stat-inline"><strong id="stat-categories">9</strong> 분류</span>
  </div>
</div>
...
<!-- AG Grid -->
<div id="abbreviations-grid" class="ag-theme-alpine ag-theme-kbo" style="height:70vh;width:100%"></div>

<!-- Status Bar -->
<div class="grid-status">
  <div class="status-left">
    <span id="status-count">118건 표시</span>
  </div>
  <div>
    <button id="btn-csv" class="btn-csv">CSV 다운로드</button>
    <span style="margin-left:8px;font-size:11px;color:#aaa">2026-02-26 갱신</span>
  </div>
</div>
