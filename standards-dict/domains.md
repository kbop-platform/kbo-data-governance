...
<div class="grid-page-info">
  <div class="grid-page-desc">데이터 타입·길이·형식의 표준 정의. 컬럼 설계의 기준 템플릿</div>
  <div class="grid-stats-inline">
    <span class="stat-inline"><strong id="stat-domains-total">93</strong> 도메인</span>
  <span class="stat-inline"><strong id="stat-columns-covered">468</strong> 컬럼 커버</span>
  <span class="stat-inline"><strong id="stat-suffixes">11</strong> 접미사</span>
  <span class="stat-inline"><strong id="stat-match-rate">-</strong> 표준 일치율</span>
  </div>
</div>
...
<div class="grid-filter-bar">
  ...
  <div class="filter-group">
    <label class="filter-label" for="sel-suffix">접미사</label>
    <select id="sel-suffix" data-field="suffix"><option value="">전체</option></select>
  </div>
  <div class="filter-group">
    <label class="filter-label" for="sel-gap">GAP</label>
    <select id="sel-gap" data-field="gap"><option value="">전체</option></select>
  </div>
...
<!-- AG Grid -->
<div id="domain-grid" class="ag-theme-alpine ag-theme-kbo" style="height:70vh;width:100%"></div>

<!-- Status Bar -->
<div class="grid-status">
  <div class="status-left">
    <span id="status-count">93건 표시</span>
  </div>
  <div>
