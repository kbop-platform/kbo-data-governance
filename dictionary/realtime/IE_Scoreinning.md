...
<tr><td class="col-num">3</td><td><span class="col-name">inning</span></td><td><span class="col-std">inning_no</span></td><td><span class="col-type">tinyint</span></td><td><span class="nn-mark">NN</span></td><td><span class="pk-badge">PK</span></td><td><span class="col-desc">이닝</span></td></tr>
<tr><td class="col-num">4</td><td><span class="col-name">Score</span></td><td><span class="col-std">score_cn</span></td><td><span class="col-type">tinyint</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">득점</span></td></tr>
<tr><td class="col-num">5</td><td><span class="col-name">bHome</span></td><td><span class="col-std">home_if</span></td><td><span class="col-type">tinyint</span></td><td><span class="nn-mark">NN</span></td><td><span class="pk-badge">PK</span></td><td><span class="col-desc">홈팀 여부 (1=홈, 0=원정)</span></td></tr>
</tbody></table>
</div>
...
<details class="dict-code-group">
<summary><code>Score</code><span class="code-desc"> &mdash; 득점</span></summary>
