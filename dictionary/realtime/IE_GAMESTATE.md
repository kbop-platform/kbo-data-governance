...
<div class="dict-hero">
  ...
  <div class="dict-hero-title">IE_GAMESTATE</div>
  <div class="dict-hero-sub">DB2_BASEBALL_NEW &middot; PK: GAMEID, GYEAR</div>
</div>

<div class="dict-quick-stats">
  <div class="dict-qs"><div class="dict-qs-val">15,237</div><div class="dict-qs-label">행 수</div></div>
...
<tr><td class="col-num">3</td><td><span class="col-name">STATUS_ID</span></td><td><span class="col-std">status_id</span></td><td><span class="col-type">tinyint</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">경기 상태 코드 (1=경기전, 2=경기중, 3=경기종료, 4=경기취소)</span></td></tr>
<tr><td class="col-num">4</td><td><span class="col-name">INN_NO</span></td><td><span class="col-std">inning_no</span></td><td><span class="col-type">tinyint</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">이닝 번호</span></td></tr>
<tr><td class="col-num">5</td><td><span class="col-name">TB_SC</span></td><td><span class="col-std">top_bottom_sc</span></td><td><span class="col-type">char(1)</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">팀 구분 코드 (T=원정, B=홈)</span></td></tr>
</tbody></table>
</div>
...
<summary><code>STATUS_ID</code><span class="code-desc"> &mdash; 경기 상태 코드</span></summary>
<div class="code-body">
<table class="dict-code-table"><thead><tr><th>값</th><th>건수</th></tr></thead><tbody>
<tr><td>3</td><td>14,029</td></tr>
<tr><td>4</td><td>1,019</td></tr>
...
<div class="code-body">
<table class="dict-code-table"><thead><tr><th>값</th><th>건수</th></tr></thead><tbody>
<tr><td>B</td><td>7,873</td></tr>
<tr><td>T</td><td>7,364</td></tr>
</tbody></table>
</div>
</details>
</div>
...
<tr><td>GAMEID</td><td>20040313HDHH0</td><td>20040313LGSS0</td><td>20040313LTSK0</td></tr>
<tr><td>GYEAR</td><td>2004</td><td>2004</td><td>2004</td></tr>
<tr><td>STATUS_ID</td><td>3</td><td>3</td><td>3</td></tr>
<tr><td>INN_NO</td><td>9</td><td>9</td><td>9</td></tr>
