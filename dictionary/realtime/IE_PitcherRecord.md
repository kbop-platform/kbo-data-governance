...
<tr><td class="col-num">3</td><td><span class="col-name">PlayerName</span></td><td><span class="col-std">player_nm</span></td><td><span class="col-type">varchar(15)</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">선수명 (EUC-KR)</span></td></tr>
...
<tr><td class="col-num">6</td><td><span class="col-name">Inning</span></td><td><span class="col-std">inning_no</span></td><td><span class="col-type">varchar(5)</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">이닝</span></td></tr>
...
<tr><td class="col-num">8</td><td><span class="col-name">PitchBallCnt</span></td><td><span class="col-std">pitch_ball_cn</span></td><td><span class="col-type">tinyint</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">볼 투구 수</span></td></tr>
<tr><td class="col-num">9</td><td><span class="col-name">PitchStrikeCnt</span></td><td><span class="col-std">pitch_strike_cn</span></td><td><span class="col-type">tinyint</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">스트라이크 투구 수</span></td></tr>
<tr><td class="col-num">10</td><td><span class="col-name">OAB</span></td><td><span class="col-std">opp_ab</span></td><td><span class="col-type">tinyint</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">상대 타수</span></td></tr>
...
<tr><td class="col-num">17</td><td><span class="col-name">HBP</span></td><td><span class="col-std">hbp</span></td><td><span class="col-type">tinyint</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">사구 (Hit by Pitch)</span></td></tr>
<tr><td class="col-num">18</td><td><span class="col-name">SO</span></td><td><span class="col-std">so</span></td><td><span class="col-type">tinyint</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">삼진</span></td></tr>
...
<tr><td class="col-num">22</td><td><span class="col-name">bHome</span></td><td><span class="col-std">home_if</span></td><td><span class="col-type">tinyint</span></td><td><span class="nn-mark">NN</span></td><td></td><td><span class="col-desc">홈팀 여부 (1=홈, 0=원정)</span></td></tr>
</tbody></table>
</div>
...
<details class="dict-code-group">
<summary><code>PitchBallCnt</code><span class="code-desc"> &mdash; 볼 투구 수</span></summary>
<div class="code-ref">고유값 20종 이상 - 상세 분포는 `raw/column-metadata.json` 참조</div>
</details>
<details class="dict-code-group">
<summary><code>PitchStrikeCnt</code><span class="code-desc"> &mdash; 스트라이크 투구 수</span></summary>
<div class="code-ref">고유값 20종 이상 - 상세 분포는 `raw/column-metadata.json` 참조</div>
</details>
<details class="dict-code-group">
...
<details class="dict-code-group" open>
<summary><code>BK</code><span class="code-desc"> &mdash; 보크</span></summary>
<div class="code-body">
<table class="dict-code-table"><thead><tr><th>값</th><th>건수</th></tr></thead><tbody>
...
<details class="dict-code-group" open>
<summary><code>WP</code><span class="code-desc"> &mdash; 폭투</span></summary>
<div class="code-body">
<table class="dict-code-table"><thead><tr><th>값</th><th>건수</th></tr></thead><tbody>
