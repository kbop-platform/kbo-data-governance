...
## 목차
1. [BatTotal](#battotal) (23컬럼, 2,615행)
2. [ENTRY](#entry) (12컬럼, 19,482행)
3. [GAMECONTAPP](#gamecontapp) (29컬럼, 57,975행)
4. [GAMEINFO](#gameinfo) (27컬럼, 551행)
5. [Hitter](#hitter) (26컬럼, 14,604행)
6. [IE_BallCount](#ie_ballcount) (11컬럼, 310행)
7. [IE_BatterRecord](#ie_batterrecord) (25컬럼, 8,507행)
8. [IE_GAMESTATE](#ie_gamestate) (5컬럼, 294행)
9. [IE_GameList](#ie_gamelist) (6컬럼, 296행)
10. [IE_LiveText](#ie_livetext) (7컬럼, 164,791행)
11. [IE_PitcherRecord](#ie_pitcherrecord) (22컬럼, 3,015행)
12. [IE_ScoreRHEB](#ie_scorerheb) (7컬럼, 622행)
13. [IE_Scoreinning](#ie_scoreinning) (5컬럼, 5,605행)
14. [KBO_BATRESULT](#kbo_batresult) (90컬럼, 6,573행)
15. [KBO_ETCGAME](#kbo_etcgame) (5컬럼, 1,957행)
16. [KBO_PITRESULT](#kbo_pitresult) (23컬럼, 2,463행)
17. [PITCHCLOCK](#pitchclock) (19컬럼, 2행)
18. [PitTotal](#pittotal) (22컬럼, 1,892행)
19. [Pitcher](#pitcher) (36컬럼, 5,706행)
20. [Score](#score) (60컬럼, 551행)
21. [TeamRank](#teamrank) (30컬럼, 165행)
...
| 23 | `SEC` | varchar(4) | N | PK | ('') |  |

**인덱스:**
| 인덱스명 | 유형 | 고유 | 컬럼 |
|---------|------|------|------|
| IX_battotal | NONCLUSTERED | N | PCODE |
| PK_BatTotal (PK) | CLUSTERED | Y | GYEAR, PCODE, SEC |
...
| 11 | `RTURN` | char(2) | Y |  |  |  |
| 12 | `HOW` | char(2) | Y |  |  |  |
| 13 | `FIELD` | varchar(20) | Y |  |  |  |
| 14 | `PLACE` | varchar(10) | Y |  |  |  |
| 15 | `HITTER` | char(5) | Y |  |  |  |
...
| 30 | `SEC` | varchar(4) | N | PK | ('') |  |

**인덱스:**
| 인덱스명 | 유형 | 고유 | 컬럼 |
|---------|------|------|------|
| PK_TeamRank (PK) | CLUSTERED | Y | GYEAR, TEAM, SEC |
