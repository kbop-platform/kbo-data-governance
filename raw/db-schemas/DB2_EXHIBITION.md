...
## 목차
1. [BatTotal](#battotal) (22컬럼, 5,127행)
2. [ENTRY](#entry) (12컬럼, 57,411행)
3. [GAMECONTAPP](#gamecontapp) (29컬럼, 124,637행)
4. [GAMEINFO](#gameinfo) (27컬럼, 1,205행)
5. [Hitter](#hitter) (26컬럼, 40,728행)
6. [IE_BallCount](#ie_ballcount) (11컬럼, 916행)
7. [IE_BatterRecord](#ie_batterrecord) (25컬럼, 35,601행)
8. [IE_GAMESTATE](#ie_gamestate) (5컬럼, 969행)
9. [IE_GameList](#ie_gamelist) (6컬럼, 916행)
10. [IE_LiveText](#ie_livetext) (7컬럼, 480,083행)
11. [IE_PitcherRecord](#ie_pitcherrecord) (22컬럼, 9,672행)
12. [IE_ScoreRHEB](#ie_scorerheb) (7컬럼, 2,022행)
13. [IE_Scoreinning](#ie_scoreinning) (5컬럼, 16,114행)
14. [KBO_BATRESULT](#kbo_batresult) (90컬럼, 29,217행)
15. [KBO_ETCGAME](#kbo_etcgame) (5컬럼, 7,092행)
16. [KBO_PITRESULT](#kbo_pitresult) (23컬럼, 8,942행)
17. [PitTotal](#pittotal) (21컬럼, 3,904행)
18. [Pitcher](#pitcher) (36컬럼, 14,756행)
19. [SEASON_PLAYER_HITTER](#season_player_hitter) (43컬럼, 466행)
20. [SEASON_PLAYER_HITTER_SITUATION](#season_player_hitter_situation) (14컬럼, 5,700행)
21. [SEASON_PLAYER_PITCHER](#season_player_pitcher) (54컬럼, 394행)
22. [SEASON_PLAYER_PITCHER_SITUATION](#season_player_pitcher_situation) (14컬럼, 5,460행)
23. [Score](#score) (60컬럼, 1,205행)
24. [TeamRank](#teamrank) (29컬럼, 214행)
...
| 2 | `P_ID` | int | N | PK |  |  |
| 3 | `SECTION_CD` | int | N | PK |  |  |
| 4 | `GROUP_IF` | varchar(20) | N | PK |  |  |
| 5 | `HRA_RT` | float | N |  |  |  |
| 6 | `GAME_CN` | int | N |  |  |  |
| 7 | `PA_CN` | int | N |  |  |  |
| 8 | `AB_CN` | int | N |  |  |  |
...
| 34 | `FO_CN` | int | N |  |  |  |
| 35 | `FOGO_RT` | float | N |  |  |  |
| 36 | `PA_PIT_RT` | float | N |  |  |  |
| 37 | `KK_BB_RT` | float | N |  |  |  |
| 38 | `SP_HRA_RT` | float | N |  |  |  |
| 39 | `PH_HRA_RT` | float | N |  |  |  |
| 40 | `OBP_RT` | float | N |  |  |  |
| 41 | `SLG_RT` | float | N |  |  |  |
| 42 | `ISO_RT` | float | N |  |  |  |
| 43 | `OPS_RT` | float | N |  |  |  |
...
| 2 | `P_ID` | int | N | PK |  |  |
| 3 | `SECTION_CD` | int | N | PK |  |  |
| 4 | `SITUATION_IF` | varchar(20) | N | PK |  |  |
| 5 | `AB_CN` | int | N |  |  |  |
| 6 | `HIT_CN` | int | N |  |  |  |
| 7 | `H2_CN` | int | N |  |  |  |
| 8 | `H3_CN` | int | N |  |  |  |
...
| 48 | `OOPS_RT` | float | N |  |  |  |
| 49 | `BABIP_RT` | float | N |  |  |  |
| 50 | `GAME_KK_RT` | float | N |  |  |  |
| 51 | `GAME_BB_RT` | float | N |  |  |  |
| 52 | `GAME_PIT_AVG_RT` | float | N |  |  |  |
| 53 | `INN_PIT_AVG_RT` | float | N |  |  |  |
| 54 | `BB_KK_RT` | float | N |  |  |  |
