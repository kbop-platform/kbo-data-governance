# DB2_MINOR_SO_BASEBALL_NEW 스키마

테이블 수: 8개

## 목차
1. [IE_BALLCOUNT](#ie_ballcount) (11컬럼, 16행)
2. [IE_BATTERRECORD](#ie_batterrecord) (25컬럼, 449행)
3. [IE_GAMELIST](#ie_gamelist) (6컬럼, 0행)
4. [IE_GAMESTATE](#ie_gamestate) (5컬럼, 16행)
5. [IE_LIVETEXT](#ie_livetext) (7컬럼, 7,813행)
6. [IE_PITCHERRECORD](#ie_pitcherrecord) (22컬럼, 141행)
7. [IE_SCOREINNING](#ie_scoreinning) (5컬럼, 279행)
8. [IE_SCORERHEB](#ie_scorerheb) (7컬럼, 32행)
