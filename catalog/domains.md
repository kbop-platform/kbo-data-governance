...
<div class="grid-stats">
  <div class="stat-card">
    <div class="stat-value" id="stat-domains-total">93</div>
    <div class="stat-label">전체 도메인</div>
  </div>
  <div class="stat-card">
    <div class="stat-value" id="stat-columns-covered">468</div>
    <div class="stat-label">컬럼 커버</div>
  </div>
  <div class="stat-card">
    <div class="stat-value" id="stat-suffixes">11</div>
    <div class="stat-label">접미사</div>
  </div>
  <div class="stat-card">
    <div class="stat-value" id="stat-match-rate">—</div>
    <div class="stat-label">표준 일치율</div>
  </div>
</div>
