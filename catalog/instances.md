...
<div class="catalog-tabs">
  ...
  <a href="../columns/"><span class="tab-icon"><svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor"><path d="M3 4.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1 0-1zm0 3h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1 0-1zm0 3h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1 0-1z"/></svg></span> 컬럼 <span class="tab-count">787</span></a>
</div>
<div class="grid-page-info">
  <div class="grid-page-desc">테이블 인스턴스별 행 수, 티어, 갱신 주기 등 운영 메타데이터</div>
